...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        # Image
        img = Image.open(r"C:\Users\KIIT0001\Desktop\images\ict.jpg")
        ...
        # Image1
        img1 = Image.open(r"C:\Users\KIIT0001\Desktop\images\download.jpg")
        ...
        # Image2
        img2 = Image.open(r"C:\Users\KIIT0001\Desktop\images\ict.jpg")
        ...
        # student button
        img4 = Image.open(r"C:\Users\KIIT0001\Desktop\images\std.jpg")
        ...
        # detect face button
        img5 = Image.open(r"C:\Users\KIIT0001\Desktop\images\reco.jpg")
        ...
        b1_1=Button(bg_img,text="Face Detector",cursor="hand2",font=("times new roman",15,"bold"),bg="lightgreen",fg="white")
        ...
        # attendance button
        img6 = Image.open(r"C:\Users\KIIT0001\Desktop\images\att.jpg")
        ...
        b1_1=Button(bg_img,text="Attendance Details",cursor="hand2",font=("times new roman",12,"bold"),bg="lightgreen",fg="white")
        b1_1.place(x=640,y=200,width=150,height=30)



        # help  button
        img7= Image.open(r"C:\Users\KIIT0001\Desktop\images\help.png")
        ...
        b1_1=Button(bg_img,text="Help Desk",cursor="hand2",font=("times new roman",16,"bold"),bg="lightgreen",fg="white")
        b1_1.place(x=860,y=200,width=150,height=30)
         ...
         # train data
        img8= Image.open(r"C:\Users\KIIT0001\Desktop\images\train.jpg")
        ...
        b1_1=Button(bg_img,text="Train Data",cursor="hand2",font=("times new roman",16,"bold"),bg="lightgreen",fg="white")
        b1_1.place(x=200,y=380,width=150,height=30)
         ...
         # photo
        img9= Image.open(r"C:\Users\KIIT0001\Desktop\images\photo.png")
        ...
        # devlopers
        img10= Image.open(r"C:\Users\KIIT0001\Desktop\images\dev.png")
        ...
        b1_1=Button(bg_img,text="Devlopers",cursor="hand2",font=("times new roman",16,"bold"),bg="lightgreen",fg="white")
        b1_1.place(x=640,y=380,width=150,height=30)



        #exit
        img11= Image.open(r"C:\Users\KIIT0001\Desktop\images\exit.jpg")
        ...
        b1_1=Button(bg_img,text="Exit",cursor="hand2",font=("times new roman",16,"bold"),bg="lightgreen",fg="white")
